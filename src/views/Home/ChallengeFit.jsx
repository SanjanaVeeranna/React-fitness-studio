  ...
  return (
    <div>
        ...
        <CardGroup>
          ...
          <Card className='m-3' style={{ border: '4px solid #cc3d00' }}>
          <Card.Img variant="top" src="https://static.wixstatic.com/media/c837a6_a89f49cbb3e446c59ac9c13b6517907b~mv2.jpg/v1/fit/w_1000,h_800,al_c,q_90/file.webp" className='card-img'/>
            <Card.Body className='p-2 border rounded'>
            <div className="d-flex align-items-center justify-content-between">
          ...
          <Card className='m-3' style={{ border: '4px solid #cc3d00' }}>
          <Card.Img variant="top" src="https://static.wixstatic.com/media/c837a6_0f4c434b9b8c4a159c8a67c2307aea48~mv2.jpg/v1/fit/w_800,h_600,al_c,q_90/file.webp=" className='card-img'/>
            <Card.Body className='p-2 border rounded'>
            <div className="d-flex align-items-center justify-content-between">
        ...
        <CardGroup>
          ...
          <Card className='m-3' style={{ border: '4px solid #cc3d00' }}>
          <Card.Img variant="top" src="https://static.wixstatic.com/media/c837a6_bf4cf6e89bbd4b0e8444a5da339af9b6~mv2.jpg/v1/fit/w_1000,h_800,al_c,q_90/file.webp" className='card-img'/>
            <Card.Body className='p-2 border rounded'>
            <div className="d-flex align-items-center justify-content-between">
          ...
          <Card className='m-3' style={{ border: '4px solid #cc3d00' }}>
          <Card.Img variant="top" src="https://static.wixstatic.com/media/c837a6_25f64eb6dc7c40ed8e4fad42007d085e~mv2.jpg/v1/fit/w_800,h_600,al_c,q_90/file.webp" className='card-img'/>
            <Card.Body className='p-2 border rounded'>
            <div className="d-flex align-items-center justify-content-between">
          ...
          <Card className='m-3' style={{ border: '4px solid #cc3d00' }}>
          <Card.Img variant="top" src="https://static.wixstatic.com/media/c837a6_d1c96dcd25aa4a62bdd2f907621a3ce0~mv2.jpg/v1/fit/w_1000,h_800,al_c,q_90/file.webp" className='card-img'/>
            <Card.Body className='p-2 border rounded'>
            <div className="d-flex align-items-center justify-content-between">
